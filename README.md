...
#### Случайные данные
![Время выполнения на случайных данных](time_comparison_random.png)

#### Обратно отсортированные
![Время выполнения на обратно отсортированных данных](time_comparison_reversed.png)
*Рисунок 2: Зависимость времени выполнения от размера массива (обратно отсортированные строки)*

#### Почти отсортированные
![Время выполнения на почти отсортированных данных](time_comparison_nearly_sorted.png)
*Рисунок 3: Зависимость времени выполнения от размера массива (почти отсортированные строки)*

#### Все типы данных (сравнение)
![Сравнение времени на всех типах данных](time_all_types.png)
*Рисунок 4: Сравнение времени выполнения алгоритмов на разных типах данных*

### Сравнение количества посимвольных сравнений

#### Случайные данные
![Сравнения на случайных данных](comparisons_random.png)
*Рисунок 5: Количество посимвольных сравнений на случайных данных*

#### Обратно отсортированные
![Сравнения на обратно отсортированных данных](comparisons_reversed.png)
*Рисунок 6: Количество посимвольных сравнений на обратно отсортированных данных*

#### Почти отсортированные
![Сравнения на почти отсортированных данных](comparisons_nearly_sorted.png)
*Рисунок 7: Количество посимвольных сравнений на почти отсортированных данных*

---

### Полное сравнение алгоритмов
![Полное сравнение алгоритмов](algorithm_comparison_full.png)
*Рисунок 8: Сводное сравнение всех алгоритмов по времени и количеству сравнений*
...
- **A1q** (Ternary String Quicksort): 375758841
